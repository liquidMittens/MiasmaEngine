...
#include <Miasma/core/glm/glm.hpp>
...
namespace tdogl {
    ...
    public:
        ...
        */
        ...
        /**
        The combined camera transformation matrix, including ortho projection.
        ...
        **/
        void initcamera(float fov, float near, float far, glm::vec3 pos, glm::vec2 screenSize);
