...
void MainScene::EnterScene()
{
	...
	explosion1->transform.translate(glm::vec3(200.0f, 200.0f, 0.0f));
	...
	testText->transform.translate(glm::vec2(500.0f, 50.0f));
	testText->AddComponent<Text>(testText.get(), "Hello World!", glm::vec3(1.0f, 0.0f, 0.0f), 10.0f);
