...
#include <Miasma/core/managers/TextureManager.h>
	...
	m_ibo(0)
{
	...
	m_material = mat;
	m_spriteName = mat.GetTextureName();
	m_spriteSize = TextureManager::GetInstance().GetTextureInfo(mat.GetTextureName())->GetTextureSize();
	m_vertices.assign(vertices.begin(), vertices.end());
	m_indices.assign(indices.begin(), indices.end());

	// scale the sprite transform to the texture size
	gameObject->transform = glm::scale(gameObject->transform.GetTransform(), glm::vec3(m_spriteSize, 1.0f));
